...
class ComicDemoSeeder extends Seeder
{
    ...
    {
        $this->definitions = [
            ['title' => 'Bulan di Ujung Jari', 'slug' => 'bulan-di-ujung-jari', 'synopsis' => 'Seorang pelukis jalanan menemukan kuas ajaib yang bisa menggambar pintu menuju dunia lain. Setiap malam purnama, dunia yang ia lukis menjadi nyata — dan mulai menginginkannya kembali.', 'genres' => ['fantasy', 'action', 'slice-of-life'], 'status' => 'ongoing', 'rating' => 4.8, 'views' => 1284000, 'likes' => 45200, 'cover_url' => 'comics/covers/comic-1.svg'],
            ['title' => 'Naga Terakhir', 'slug' => 'naga-terakhir', 'synopsis' => 'Setelah 500 tahun bersembunyi, naga terakhir bangkit di era modern. Remaja bernama Bima terpilih menjadi penjaganya — padahal ia hanya ingin lulus SMA dengan tenang.', 'genres' => ['action', 'fantasy', 'adventure'], 'status' => 'ongoing', 'rating' => 4.6, 'views' => 982000, 'likes' => 33100, 'cover_url' => 'comics/covers/comic-2.svg'],
            ['title' => 'Cinta Tak Berbalas', 'slug' => 'cinta-tak-berbalas', 'synopsis' => 'Setiap hari Laras menulis surat cinta yang tak pernah ia kirim. Suatu hari, semua surat itu menemukan jalannya sendiri — dan sampai ke orang yang salah.', 'genres' => ['romance', 'drama'], 'status' => 'ongoing', 'rating' => 4.5, 'views' => 756000, 'likes' => 28900, 'cover_url' => 'comics/covers/comic-3.svg'],
            ['title' => 'Kost Paranormal', 'slug' => 'kost-paranormal', 'synopsis' => 'Kost murah di pinggir kota ternyata dihuni penghuni lain: hantu-hantu baik hati yang butuh bantuan menyelesaikan urusan duniawi mereka. Komedi horor yang menghangatkan hati.', 'genres' => ['horror', 'comedy', 'slice-of-life'], 'status' => 'completed', 'rating' => 4.4, 'views' => 642000, 'likes' => 21000, 'cover_url' => 'comics/covers/comic-4.svg'],
            ['title' => 'Rekan Buatan', 'slug' => 'rekan-buatan', 'synopsis' => 'Di tahun 2147, android generasi terbaru diberi satu misi: menjadi sahabat bagi anak-anak yang kesepian. Tapi apa jadinya jika android itu mulai bertanya tentang perasaannya sendiri?', 'genres' => ['sci-fi', 'drama'], 'status' => 'ongoing', 'rating' => 4.7, 'views' => 1105000, 'likes' => 39800, 'cover_url' => 'comics/covers/comic-5.svg'],
            ['title' => 'Pedang Senja', 'slug' => 'pedang-senja', 'synopsis' => 'Dunia di ambang kegelapan abadi. Satu-satunya harapan adalah pedang legendaris yang hanya bisa diangkat oleh mereka yang tak punya apa-apa untuk dilindungi.', 'genres' => ['action', 'fantasy', 'thriller'], 'status' => 'hiatus', 'rating' => 4.3, 'views' => 523000, 'likes' => 17400, 'cover_url' => 'comics/covers/comic-6.svg'],
            ['title' => 'Secangkir Kenangan', 'slug' => 'secangkir-kenangan', 'synopsis' => 'Kedai kopi kecil di sudut kota menyimpan rahasia: setiap cangkir yang disajikan bisa mengembalikan satu kenangan pelanggannya. Cerita slice-of-life tentang cinta, kehilangan, dan harapan.', 'genres' => ['slice-of-life', 'romance', 'drama'], 'status' => 'completed', 'rating' => 4.9, 'views' => 890000, 'likes' => 41200, 'cover_url' => 'comics/covers/comic-7.svg'],
            ['title' => 'Kasus Nol', 'slug' => 'kasus-nol', 'synopsis' => 'Detektif muda yang skeptis dipaksa bekerja sama dengan paranormal jenius untuk memecahkan "kasus nol" — pembunuhan yang terjadi sebelum korban lahir.', 'genres' => ['thriller', 'horror', 'sci-fi'], 'status' => 'ongoing', 'rating' => 4.6, 'views' => 668000, 'likes' => 22500, 'cover_url' => 'comics/covers/comic-8.svg'],
            ['title' => 'Menara Tanpa Puncak', 'slug' => 'menara-tanpa-puncak', 'synopsis' => 'Menara misterius muncul di tengah kota setiap 100 tahun. Seorang pendaki bernama Sakura masuk sendirian untuk menemukan jawaban di lantai teratas — yang tak pernah ada.', 'genres' => ['fantasy', 'thriller', 'adventure'], 'status' => 'ongoing', 'rating' => 4.7, 'views' => 745000, 'likes' => 26800, 'cover_url' => 'comics/covers/comic-9.svg'],
            ['title' => 'Si Rubah Juga', 'slug' => 'si-rubah-juga', 'synopsis' => 'Rubah berbulu sembilan yang bisa berubah wujud memutuskan menjadi YouTuber agar bisa membeli mahkota surgawi. Petualangan konyol dengan sentuhan mitologi.', 'genres' => ['comedy', 'fantasy'], 'status' => 'ongoing', 'rating' => 4.2, 'views' => 334000, 'likes' => 11900, 'cover_url' => 'comics/covers/comic-10.svg'],
            ['title' => 'Jatuh dari Bintang', 'slug' => 'jatuh-dari-bintang', 'synopsis' => 'Bintang jatuh yang menjelma gadis kecil menumpang hidup di rumah seorang penyendiri. Ia mencoba memahami dunia manusia — dan manusia belajar merindukan langit.', 'genres' => ['slice-of-life', 'romance', 'fantasy'], 'status' => 'ongoing', 'rating' => 4.5, 'views' => 587000, 'likes' => 20300, 'cover_url' => 'comics/covers/comic-11.svg'],
            ['title' => 'Tengkorak Tertawa', 'slug' => 'tengkorak-tertawa', 'synopsis' => 'Setiap orang yang menerima tengkorak ukiran misterius akan tertawa tanpa henti selama 24 jam. Seorang reporter mengejar asal usulnya — dan menemukan dirinya sebagai target berikutnya.', 'genres' => ['horror', 'thriller'], 'status' => 'hiatus', 'rating' => 4.1, 'views' => 289000, 'likes' => 9800, 'cover_url' => 'comics/covers/comic-12.svg'],
        ];
    }
    ...
    private function upsertComic(int $index, array $definition, array $creators): Comic
    {
        $comic = Comic::updateOrCreate(
            ...
            [
                ...
                'cover_url' => $definition['cover_url'] ?? null,
    ...
    private function upsertPages(Episode $episode): void
    {
        for ($page = 1; $page <= 10; $page++) {
            EpisodePage::updateOrCreate(
                ...
                [
                    'image_url' => "demo-pages/comic-{$episode->comic_id}/episode-{$episode->id}/p{$page}.svg",
                ]
            );
        }
    }
