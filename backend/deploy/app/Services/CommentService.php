...
{
    private readonly CommentCensorService $censorService;

    public function __construct(CommentCensorService $censorService)
    {
    ...
    public function create(User $user, Comic $comic, array $data): Comment
    {
        ...
        // Sensor kata kotor secara otomatis
        $censoredContent = $this->censorService->censor($data['content']);
    ...
    public function update(Comment $comment, array $data): Comment
    {
        ...
        $comment->update(['content' => $censoredContent]);
